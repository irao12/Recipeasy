...
export default function RecipeBox({recipe}) {
    const {title, image:imageURL, readyInMinutes:time, missingIngredients, sourceUrl:recipeURL, id:recipeID} = recipe;
  ...
  return (
    <div className="recipe-box">
        <div className="recipe-content">
            <img src={isFavorited ? HeartFilled : HeartUnfilled} alt={isFavorited ? "favorited" : "not favorited"}
            ...
            <div className="time-and-status">
                ...
                <img className="recipe-status" src={statusIcon} alt="status"/>
            </div>
        </div>
    </div>
  )
